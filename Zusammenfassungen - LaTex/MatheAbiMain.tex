...
Gleichungsysteme können auch zur Rekonstruktion von Funktionen verwendet werden. Dazu werden gewisse Bedingungen vorrausgesetzt,
die in ein Gleichungssystem umgewandelt werden können. Beispiel: Eine Parabel hat die allgemeine Form: $ax^2+bx+c$
